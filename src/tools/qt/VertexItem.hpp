#ifndef QMEDUSA_VERTEX_ITEM_HPP
#define QMEDUSA_VERTEX_ITEM_HPP
...
class VertexItem : public QObject, public QGraphicsItem, public medusa::DisassemblyView
{
  Q_OBJECT
  Q_INTERFACES(QGraphicsItem)

public:
  VertexItem(QObject * parent, medusa::Medusa& core, medusa::Address::Vector const& addresses);
