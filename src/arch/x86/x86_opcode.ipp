...
private:
  ...
  Expression::SPType Decode_Ibsq(BinaryStream const& rBinStrm, TOffset& rOffset, Instruction& rInsn, u8 Mode);
  ...
  Expression::SPType Decode_Izsq(BinaryStream const& rBinStrm, TOffset& rOffset, Instruction& rInsn, u8 Mode);
